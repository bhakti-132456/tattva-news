            ...
            <main className="tattva-main">
                ...
                <div className="animate-fade-in" style={{ maxWidth: '1000px', margin: '0 auto', paddingBottom: '3rem' }}>
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '2rem' }}>
                        ...
                        <div style={{ display: 'flex', gap: '0.5rem', background: 'white', padding: '0.25rem', borderRadius: '0.5rem', boxShadow: '0 1px 2px rgba(0,0,0,0.1)' }}>
                            <button
                                ...
                                style={{
                                    ...
                                    border: 'none',
                                    background: activeTab === 'analytics' ? '#0F172A' : 'transparent',
                            ...
                            <button
                                ...
                                style={{
                                    ...
                                    borderRadius: '0.375rem',
                                    border: 'none',
                                    background: activeTab === 'manage' ? '#0F172A' : 'transparent',
                                    ...
                                    <div>
                                        <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', marginBottom: '0.5rem' }}>
                                            ...
                                            <label htmlFor="has-table" style={{ fontSize: '0.875rem', fontWeight: '600', display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                                                <ImageIcon size={16} /> {/* Replace with Table icon if available */}
                                                Include Data Table?
                                            </label>
                                        </div>
